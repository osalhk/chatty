        ...
        <div className="min-h-screen w-full bg-white flex flex-col md:flex-row">
            <div className="w-full md:w-6/12 bg-sky-500 p-8 text-white flex flex-col justify-center">
                ...
                <div className="mt-10 text-center">
                    <p className="text-sm opacity-80">Join thousand of users today!</p>
                </div>
            </div>
            <div className="w-full md:w-6/12 flex p-8 justify-center item-center ">
                {islogin ? (
                    <div className="w-full md:w-[400 px]">
